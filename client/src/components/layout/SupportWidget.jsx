          ...
          >
            ...
            <div className="p-4 bg-primary-500/10 border-b border-dark-700/60 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-semibold text-dark-50 text-sm">Campus Support</h3>
                  <span className="text-xs text-accent-500 font-medium">Class Agents Active</span>
                </div>
              </div>
              <button
                onClick={() => setIsOpen(false)}
            ...
            {/* Content Body */}
            <div className="p-4 max-h-[350px] overflow-y-auto no-scrollbar space-y-4">
